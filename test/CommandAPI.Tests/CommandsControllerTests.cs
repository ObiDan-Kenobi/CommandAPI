...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        public void GetCommandItems_Returns200OK_WhenDBIsEmpty()
        {
            //Arrange
            mockRepo.Setup(
                repo => repo.GetAllCommands()).Returns(GetCommands(0));
        ...
        public void GetCommandById_Returns404NotFound_WhenNonExistingIDProvided()
        {
            //Arrange
            mockRepo.Setup(
                repo => repo.GetCommandById(0)).Returns(() => null);
            var controller = new CommandsController(mockRepo.Object, mapper);
        ...
        public void GetCommandById_Returns200OK_WhenValidIDProvided()
        {
            //Arrange
            mockRepo.Setup(
                repo => repo.GetCommandById(1)).Returns(() => new Command()
                {
                    Id = 1,
                    HowTo = "mock",
                    Platform = "Mock",
        ...
        public void PartialCommandUpdate_Returns404NotFound_WhenNonExistentResourceIDSubmitted()
        {
            ...
            var controller = new CommandsController(mockRepo.Object, mapper);
            //Act
            var result = controller.UpdateCommand(0,
